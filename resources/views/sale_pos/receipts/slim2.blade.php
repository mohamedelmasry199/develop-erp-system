...
<html lang="en">
    ...
    <body>
        <div class="ticket">
	                    ...
	                    <tr class="bb-lg">
	                        <td class="description">
	                        	<div style="display:flex; width: 100%;">
	                        		...
	                        		<p class="text-left m-0 mt-5 pull-left"><b>{{$line['name']}} </b> 
			...
			@if(1)
				<img class="center-block mt-5" src="https://goldledgers.com/qrcode.php?s={{$receipt_details->display_name}}&x={{ $receipt_details->tax_info1 }}&t={{$receipt_details->invoice_date}}&a={{$receipt_details->total}}&v=5"><br><br>
			@endif
