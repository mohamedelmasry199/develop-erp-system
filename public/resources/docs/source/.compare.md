...
[Get Postman Collection](https://goldledgers.com/test/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "https://goldledgers.com/test/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"iusto","ip_address":"explicabo","latitude":"error","longitude":"expedita"}'
...
```bash
curl -X POST \
    "https://goldledgers.com/test/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"non","latitude":"in","longitude":"non"}'
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/holidays?location_id=1&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=quia&follow_up_type=non&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "https://goldledgers.com/test/public/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"magnam","schedule_type":"reiciendis","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=nemo&biz_name=mollitia&mobile_num=16&contact_id=voluptatem&order_by=blanditiis&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "https://goldledgers.com/test/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"earum","mobile_name":"et","call_type":"call","start_time":"illum","end_time":"veniam","duration":"nulla"}]}'
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=1&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":24390071.399999998509883880615234375,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":5726037.14737999998033046722412109375,"total_card_slips":12,"total_cheques":17,"closing_note":"beatae","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 1,
    "initial_amount": 24390071.399999998509883880615234375,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 5726037.14737999998033046722412109375,
    "total_card_slips": 12,
    "total_cheques": 17,
    "closing_note": "beatae",
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/contactapi?type=qui&name=ipsam&biz_name=eum&mobile_num=16&contact_id=tempora&order_by=qui&direction=dolorem&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"ut","prefix":"quasi","first_name":"minus","middle_name":"repellendus","last_name":"qui","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"quos","address_line_2":"consequuntur","city":"debitis","state":"ipsum","country":"tempora","zip_code":"vel","customer_group_id":"dolor","contact_id":"id","dob":"2000-06-13","custom_field1":"est","custom_field2":"inventore","custom_field3":"dolorem","custom_field4":"asperiores","email":"quae","shipping_address":"earum","position":"et","opening_balance":0,"source_id":7,"life_stage_id":19,"assigned_to":[]}'
...
let body = {
    ...
    "dob": "2000-06-13",
    "custom_field1": "est",
    "custom_field2": "inventore",
    "custom_field3": "dolorem",
    "custom_field4": "asperiores",
    "email": "quae",
    "shipping_address": "earum",
    "position": "et",
    "opening_balance": 0,
    "source_id": 7,
    "life_stage_id": 19,
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"repudiandae","prefix":"voluptatum","first_name":"asperiores","middle_name":"est","last_name":"veniam","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"aperiam","address_line_2":"a","city":"fugit","state":"earum","country":"est","zip_code":"adipisci","customer_group_id":"vel","contact_id":"et","dob":"2000-06-13","custom_field1":"consectetur","custom_field2":"omnis","custom_field3":"explicabo","custom_field4":"earum","email":"ut","shipping_address":"amet","position":"tempora","opening_balance":10.300000000000000710542735760100185871124267578125,"source_id":4,"life_stage_id":11,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "repudiandae",
    "prefix": "voluptatum",
    ...
    "country": "est",
    "zip_code": "adipisci",
    "customer_group_id": "vel",
    "contact_id": "et",
    "dob": "2000-06-13",
    "custom_field1": "consectetur",
    "custom_field2": "omnis",
    "custom_field3": "explicabo",
    "custom_field4": "earum",
    "email": "ut",
    "shipping_address": "amet",
    "position": "tempora",
...
```bash
curl -X POST \
    "https://goldledgers.com/test/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":13,"card_number":"ratione","card_holder_name":"totam","card_transaction_number":"et","card_type":"eos","card_month":"recusandae","card_year":"doloribus","card_security":"sit","transaction_no_1":"sapiente","transaction_no_2":"soluta","transaction_no_3":"quia","cheque_number":"omnis","bank_account_number":"iure","note":"non"}'
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=id&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":170.959999269999997295599314384162425994873046875,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":4,"expense_for":8,"contact_id":6,"expense_category_id":16,"expense_sub_category_id":4,"additional_notes":"accusamus","is_refund":0,"is_recurring":0,"recur_interval":14,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"illum","recur_repetitions":8,"payment":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":19,"card_number":"laboriosam","card_holder_name":"nam","card_transaction_number":"dolore","card_type":"excepturi","card_month":"voluptatibus","card_year":"quia","card_security":"nihil","transaction_no_1":"et","transaction_no_2":"ratione","transaction_no_3":"rerum","note":"sapiente","cheque_number":"et"}]}'
...
let body = {
    "location_id": 1,
    "final_total": 170.959999269999997295599314384162425994873046875,
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "https://goldledgers.com/test/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":164196.89999999999417923390865325927734375,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":20,"expense_for":13,"contact_id":18,"expense_category_id":16,"expense_sub_category_id":14,"additional_notes":"culpa","is_recurring":0,"recur_interval":20,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"blanditiis","recur_repetitions":9,"payment":[]}'
...
let body = {
    "final_total": 164196.89999999999417923390865325927734375,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 20,
    "expense_for": 13,
    "contact_id": 18,
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/expense-refund?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=qui&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/expense-categories" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/expense-categories"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/field-force?contact_id=et&assigned_to=nobis&status=quidem&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/field-force"
);
...
```bash
curl -X POST \
    "https://goldledgers.com/test/public/connector/api/field-force/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":7,"visit_to":"excepturi","visit_address":"deleniti","assigned_to":15,"visit_on":"2021-12-28 17:23:00","visit_for":"quasi"}'
...
```bash
curl -X POST \
    "https://goldledgers.com/test/public/connector/api/field-force/update-visit-status/17" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"ullam","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"quia","photo":"dolor"}'
...
let body = {
    "status": "finished",
    "reason_to_not_meet_contact": "ullam",
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/product?order_by=nemo&order_direction=velit&brand_id=quibusdam&category_id=dolorem&sub_category_id=fugit&location_id=1&selling_price_group=est&send_lot_detail=aut&name=explicabo&sku=rerum&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/product"
);

let params = {
    "order_by": "nemo",
    "order_direction": "velit",
    "brand_id": "quibusdam",
    "category_id": "dolorem",
    "sub_category_id": "fugit",
    "location_id": "1",
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/product/1?selling_price_group=omnis&send_lot_detail=magnam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/product/1"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/variation/2?product_id=ut&location_id=1&brand_id=hic&category_id=et&sub_category_id=hic&not_for_selling=repellendus&name=non&sku=vitae&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/variation/2"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/sell?location_id=1&contact_id=alias&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=rem&service_staff_id=nisi&shipping_status=ordered&source=unde&only_subscriptions=sed&send_purchase_details=sint&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/sell"
);
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "rem",
    "service_staff_id": "nisi",
    "shipping_status": "ordered",
    "source": "unde",
    "only_subscriptions": "sed",
    "send_purchase_details": "sint",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":13,"transaction_date":"2020-07-22 15:48:29","invoice_no":"laudantium","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":19,"discount_amount":10,"discount_type":"fixed","sale_note":"repellat","staff_note":"dolorem","commission_agent":3,"shipping_details":"Express Delivery","shipping_address":"atque","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":8,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":12,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"facere","recur_repetitions":3,"rp_redeemed":12,"rp_redeemed_amount":13.5,"types_of_service_id":3,"service_custom_field_1":"qui","service_custom_field_2":"quae","service_custom_field_3":"sit","service_custom_field_4":"nostrum","service_custom_field_5":"error","service_custom_field_6":"enim","round_off_amount":2.5099999999999997868371792719699442386627197265625,"table_id":18,"service_staff_id":15,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":3,"note":"quaerat"}],"payments":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":15,"card_number":"quae","card_holder_name":"occaecati","card_transaction_number":"aut","card_type":"dolorum","card_month":"delectus","card_year":"cupiditate","card_security":"veniam","transaction_no_1":"qui","transaction_no_2":"quasi","transaction_no_3":"qui","bank_account_number":"enim","note":"sed","cheque_number":"provident"}]}]}'
    ...
    "sells": [
        {
            ...
            "service_custom_field_2": "quae",
            "service_custom_field_3": "sit",
            "service_custom_field_4": "nostrum",
            "service_custom_field_5": "error",
            "service_custom_field_6": "enim",
            "round_off_amount": 2.5099999999999997868371792719699442386627197265625,
            "table_id": 18,
            "service_staff_id": 15,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_security": "veniam",
                    "transaction_no_1": "qui",
                    "transaction_no_2": "quasi",
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/sell/55?send_purchase_details=incidunt" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/sell/55"
);

let params = {
    "send_purchase_details": "incidunt",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X PUT \
    "https://goldledgers.com/test/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":5,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":16,"discount_amount":10,"discount_type":"fixed","sale_note":"nulla","source":"fugiat","staff_note":"ut","is_suspend":false,"commission_agent":20,"shipping_details":"Express Delivery","shipping_address":"mollitia","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":15,"pay_term_number":14,"pay_term_type":"months","is_recurring":0,"recur_interval":1,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"voluptatum","recur_repetitions":10,"rp_redeemed":9,"rp_redeemed_amount":13.5,"types_of_service_id":6,"service_custom_field_1":"sapiente","service_custom_field_2":"quibusdam","service_custom_field_3":"quis","service_custom_field_4":"fuga","service_custom_field_5":"facere","service_custom_field_6":"labore","round_off_amount":10491,"table_id":3,"service_staff_id":14,"change_return":0,"change_return_id":10,"products":[{"sell_line_id":6,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":5,"discount_amount":0,"discount_type":"percentage","sub_unit_id":17,"note":"dolor"}],"payments":[{"payment_id":2,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":16,"card_number":"eos","card_holder_name":"porro","card_transaction_number":"et","card_type":"enim","card_month":"molestias","card_year":"fuga","card_security":"laboriosam","transaction_no_1":"qui","transaction_no_2":"quia","transaction_no_3":"provident","note":"qui","cheque_number":"rerum","bank_account_number":"qui"}]}'
...
let body = {
    ...
    "service_custom_field_1": "sapiente",
    "service_custom_field_2": "quibusdam",
    "service_custom_field_3": "quis",
    "service_custom_field_4": "fuga",
    "service_custom_field_5": "facere",
    "service_custom_field_6": "labore",
    "round_off_amount": 10491,
    "table_id": 3,
    "service_staff_id": 14,
    "change_return": 0,
    "change_return_id": 10,
    ...
    "payments": [
        {
            ...
            "account_id": 16,
            "card_number": "eos",
            "card_holder_name": "porro",
            "card_transaction_number": "et",
            "card_type": "enim",
            "card_month": "molestias",
            "card_year": "fuga",
            "card_security": "laboriosam",
            "transaction_no_1": "qui",
...
```bash
curl -X DELETE \
    "https://goldledgers.com/test/public/connector/api/sell/et" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "https://goldledgers.com/test/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":3,"transaction_date":"2020-5-7 15:20:22","invoice_no":"sunt","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":9,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "https://goldledgers.com/test/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":17,"shipping_status":"ordered","delivered_to":"blanditiis"}'
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/table?location_id=1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/taxonomy?type=voluptas" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/user/loggedin"
);
...
```bash
curl -X POST \
    "https://goldledgers.com/test/public/connector/api/user-registration" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"rerum","first_name":"molestiae","last_name":"nobis","email":"sequi","is_active":"unde","user_type":"voluptatem","crm_contact_id":18,"allow_login":false,"username":"eveniet","password":"autem","role":9,"access_all_locations":false,"location_permissions":[],"cmmsn_percent":"doloremque","max_sales_discount_percent":"quia","selected_contacts":true,"selected_contact_ids":[],"dob":"perferendis","gender":"totam","marital_status":"assumenda","blood_group":"debitis","contact_number":"eos","alt_number":"quia","family_number":"provident","fb_link":"est","twitter_link":"et","social_media_1":"ducimus","social_media_2":"aut","custom_field_1":"magnam","custom_field_2":"sapiente","custom_field_3":"eum","custom_field_4":"dolor","guardian_name":"laudantium","id_proof_name":"et","id_proof_number":"corporis","permanent_address":"reiciendis","current_address":"enim","bank_details":[{"account_holder_name":"facilis","account_number":"quod","bank_name":"nemo","bank_code":"eum","branch":"rerum","tax_payer_id":"quasi"}]}'
...
let body = {
    ...
    "cmmsn_percent": "doloremque",
    "max_sales_discount_percent": "quia",
    "selected_contacts": true,
    "selected_contact_ids": [],
    "dob": "perferendis",
    "gender": "totam",
    "marital_status": "assumenda",
    "blood_group": "debitis",
    "contact_number": "eos",
    "alt_number": "quia",
    "family_number": "provident",
    "fb_link": "est",
    "twitter_link": "et",
    "social_media_1": "ducimus",
    "social_media_2": "aut",
    "custom_field_1": "magnam",
    "custom_field_2": "sapiente",
    "custom_field_3": "eum",
    "custom_field_4": "dolor",
    "guardian_name": "laudantium",
    "id_proof_name": "et",
    "id_proof_number": "corporis",
    "permanent_address": "reiciendis",
    "current_address": "enim",
    "bank_details": [
        {
            "account_holder_name": "facilis",
            "account_number": "quod",
            "bank_name": "nemo",
            "bank_code": "eum",
            "branch": "rerum",
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/user?service_staff=eos" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/user"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "https://goldledgers.com/test/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"similique","new_password":"veniam"}'
...
```bash
curl -X POST \
    "https://goldledgers.com/test/public/connector/api/forget-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"email":"reiciendis"}'
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/profit-loss-report?location_id=1&start_date=2018-06-25&end_date=2018-06-25&user_id=1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/notifications"
);
...
```bash
curl -X GET \
    -G "https://goldledgers.com/test/public/connector/api/get-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
...
```javascript
const url = new URL(
    "https://goldledgers.com/test/public/connector/api/get-location"
);
